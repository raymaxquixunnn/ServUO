...
namespace Server.Items
{
    ...
    public class LeatherGlovesOfLumberjacking : BaseGlovesOfLumberjacking
	{
        ...
        }// leather blacksmith gloves of Lumberjacking
    ...
    public class StuddedGlovesOfLumberjacking : BaseGlovesOfLumberjacking
    {
        ...
        }// studded leather blacksmith gloves of Lumberjacking
        public override void Serialize(GenericWriter writer)
        {
            base.Serialize(writer);
            writer.Write((int)0);
    ...
    [Alterable(typeof(DefBlacksmithy), typeof(GargishKiltOfLumberjacking))]
    ...
    public class RingmailGlovesOfLumberjacking : BaseGlovesOfLumberjacking
    {
        ...
        }// ringmail blacksmith gloves of Lumberjacking
        public override void Serialize(GenericWriter writer)
        {
            base.Serialize(writer);
            writer.Write((int)0);
    ...
    [FlipableAttribute(0x13eb, 0x13f2)]
    public class GargishKiltOfLumberjacking : BaseGlovesOfLumberjacking
    {
        ...
        [Constructable]
        public GargishKiltOfLumberjacking() : this(5)
        {
        }

        [Constructable]
        public GargishKiltOfLumberjacking(int bonus)
            : base(bonus, 0x030C)
        {
            Weight = 1;
        }

        public GargishKiltOfLumberjacking(Serial serial)
            : base(serial)
        {
        }
    ...
    public abstract class BaseGlovesOfLumberjacking : BaseArmor
    {
        ...
        public int Bonus
        {
            ...
            set
            {
                ...
                {
                    this.m_SkillMod = new DefaultSkillMod(SkillName.Lumberjacking, true, this.m_Bonus);
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            if (this.m_Bonus != 0)
                list.Add(1062005, this.m_Bonus.ToString()); // Lumberjacking bonus +~1_val~
        }
