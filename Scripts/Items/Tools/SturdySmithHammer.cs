...
namespace Server.Items
{
    ...
    public class SturdySmithHammer : BaseTool, IUsesRemaining
    {
        [Constructable]
        public SturdySmithHammer()
            : this(180)
        {
        }

        [Constructable]
        public SturdySmithHammer(int uses)
            : base(uses, 0x13E3)
        {
            this.Weight = 8.0;
        ...
        public SturdySmithHammer(Serial serial)
            : base(serial)
        {
        }

        public override string DefaultName { get { return "sturdy smithy hammer"; } }
    ...
    public class SturdySmithyHammer : BaseBashing, ITool
    {
        [Constructable]
        public SturdySmithyHammer()
            : base(0x13E3)
        {
            Weight = 8.0;
        ...
        public SturdySmithyHammer(Serial serial)
            : base(serial)
        {
        }
